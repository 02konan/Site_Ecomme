document.addEventListener("DOMContentLoaded", () => {
    ...
    if (document.getElementById("sous-categorie-produits")) {
        Sous_Categorie(id);
    }
...
function Categorie(id) {
    ...
    fetch(`/categorie_produits/${id}`)
        .then(res => res.json())
        .then(response => {
            if (response.data) affichecategorie(response.data,"categorie-produits");
        })
        .catch(err => {
...
function Sous_Categorie(id) {
    
    fetch(`/sous_categorie_produits/${id}`)
        .then(res => res.json())
        .then(response => {
            if (response.data) affichesouscategorie(response.data,"sous-categorie-produits");
        })
        .catch(err => {
            console.error("Erreur produits:", err);
        });
...
function affichecategorie(produits,idcontainer) {
...
function affichesouscategorie(produits,idcontainer) {
    const container = document.getElementById(idcontainer);
    if (!container) return;
    container.innerHTML = "";
